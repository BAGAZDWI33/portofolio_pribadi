...
<head>
    ...
    <title>Bagas dwi prasetyo| portofolio
    </title>
    <!-- font icons -->
    <link rel="stylesheet" href="assets/vendors/themify-icons/css/themify-icons.css">
    <!-- Bootstrap + Meyawo main styles -->
    <link rel="stylesheet" href="assets/css/meyawo.css">
    <link rel="stylesheet" href="assets/css/floatingWA.css">
</head>
...
<body data-spy="scroll" data-target=".navbar" data-offset="40" id="home">
    ...
    <nav class="custom-navbar" data-spy="affix" data-offset-top="20">
        <div class="container">
            <a class="logo" href="#">Bagas Dwi Prasetyo</a>
            <ul class="nav">
                <li class="item">
        ...
        <div class="header-content container">
            ...
            <body>
                <div class="container text-center">
                    ...
                    <p class="lead">Berdiri Dikaki Sendiri dan Guncang Dunia!</p>
                </div>
            </body>
...
<h1 class="header-title">
    ...
    <span class="down">I am Prasetyo B.D</span>
</h1>
<p class="header-subtitle">FRONTEND WEB DESIGNER|UI UX Desain junior|Data Analyst</p>
    ...
    <div class="container text-center">
        ...
        <div class="about">
            ...
            <div class="about-caption">
                ...
                <p>
                    Results-oriented IT professional specializing in web development, UI/UX design, and data
                    analysis. Currently in the seventh semester pursuing a degree in Computer Engineering at Pelita
                    Bangsa University. Combining advanced technical expertise with a unique background as a skilled
                    welding operator in a renowned company, I offer a distinctive blend of complex and structured
                    skills. Additionally, I have experience interning with PT NOK Indonesia and won 3rd place in a
                    UI/UX design competition. Eager to leverage these skills as a Junior Programmer to contribute to
                    cutting-edge projects and further enhance my capabilities in the ever-evolving IT landscape.
                    <br>I possess IT skills including IoT and intermediate-level data analytics, with experience in
                    managing community website projects and other commercial web platforms. Additionally, I have
                    interned at PT NOK Indonesia and achieved 3rd place in a UI/UX design competition. Supported by
                    these capabilities, I am eager to leverage my skills as a Junior Programmer, contribute to
                    innovative projects, and further enhance my expertise in the ever-evolving IT landscape.
                </p>
...
<div class="floating-buttons">
    <a href="https://wa.me/6282324757905" class="whatsapp-button" target="_blank">
        <img src="./assets/imgs/logo_WA.svg" alt="WhatsApp">
    </a>
